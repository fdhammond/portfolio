        ...
        <Stack>
            ...
            <Flex direction={isNotSmallerScreen ? "row" : "column"} spacing="200px" p={isNotSmallerScreen ? "32" : "0"} alignSelf="flex-start" >
                <Box mt={isNotSmallerScreen ? "0" : 16} align="flex-start">
                    ...
                    <Text fontSize="7xl" fontWeight="semibold" bgGradient="linear(to-r, cyan.400, blue.500, purple.600)" bgClip='text'>Hammond Federico</Text>
                    <Text color={isDark ? "gray.200" : "gray.500"}>Front End Developer - Learning ReactJS, NextJS.</Text>
                <Button mt={8} colorScheme="blue" onClick={() => window.open("https://www.google.com")}
                >Hire Me</Button>
                </Box>
                <Image
